...
for (i = 10; i <= 110; i += 25) {
    ...
    document.getElementById("q5").innerHTML = "<p>" + "For: At home, I have " + i + " cats." + "</p>";
}

var cats = 10;
while (cats <= 110) {

    document.getElementById("q5a").innerHTML = "<p>" + "While: At home, I have " + cats + " cats." + "</p>";
    cats += 25;
}
...
//     if (coin === 1) {
//         result = "heads";
//         document.getElementById("q18").innerHTML = "<p>Heads. Keep Trying!</p>";
//     } else {
//         result = "tails";
//         document.getElementById("q19").innerHTML = "<p>Tails!</p>";
//     }
